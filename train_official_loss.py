# train_official_loss.py
# train.py
# Custom training script for YOLOv5 pedestrian detection project using official loss
...
# ✅ Initialize YOLOv5 official loss function
...
for epoch in range(epochs):
    ...
    for imgs, targets in train_loader:
        ...
        # ✅ Official loss returns (box, obj, cls)
        loss_items = loss_fn(preds, targets)
        loss = sum(loss_items) if isinstance(loss_items, (list, tuple)) else loss_items
